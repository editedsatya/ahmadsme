; (function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        _getNewPopupID: function (pluginName) {
            var thisPopupID = pluginName + '_Popup_' + (this._uuidv4());
        ...
        */
        ...
        _getListItem: function (obj) {
            ...
            if (obj) {
                ...
                var nodeDisabled = node.nodeDisabled;
                ...
                liSpan.className = 'sac-node-name sac-noselect ' + selClass;
                 ...
                 //Added by ahmed 27/08/2019
                var disClass = (nodeDisabled === true) ? 'sac-node-disabled' : '';
                liSpan.className = liSpan.className + ' ' + disClass;
