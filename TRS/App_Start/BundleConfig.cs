    ...
    public class BundleConfig
    {
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/AdminLTE/bootstrap/css").Include(
                ...
                "~/AdminLTE/bootstrap/css/site.css"));
            

            // bootstrap rtl
            bundles.Add(new StyleBundle("~/AdminLTE/bootstrap/js-rtl").Include(
               "~/AdminLTE/bootstrap/js/bootstrap-rtl.min.js"));

            bundles.Add(new StyleBundle("~/AdminLTE/bootstrap/css-rtl").Include(
                "~/AdminLTE/bootstrap/css/bootstrap-rtl.min.css"));
            ...
            bundles.Add(new StyleBundle("~/AdminLTE/dist/css-rtl").Include(
               "~/AdminLTE/dist/css/AdminLTE-rtl.min.css"));

            bundles.Add(new StyleBundle("~/AdminLTE/dist/css/skins").Include(
                "~/AdminLTE/dist/css/skins/_all-skins.min.css"));

            bundles.Add(new StyleBundle("~/AdminLTE/dist/css/skins-rtl").Include(
               "~/AdminLTE/dist/css/skins/_all-skins-rtl.min.css"));
